...
### Binding
#### For reliable bindings, press bind in the Zigbee2MQTT interface and move in front of the sensor to wake it up. This can be done once every 90 seconds. If the sensor is sleeping the bind will fail. 
